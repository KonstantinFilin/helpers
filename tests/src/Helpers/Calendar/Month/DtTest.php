...
class DtTest extends TestCase {
    /**
     * @covers Helpers\Calendar\Month\Dt::getAsStr
     */
    ...
    /**
     * @covers Helpers\Calendar\Month\Dt::getAsObj
     */
    public function testGetAsObj() {
        ...
        $this->assertTrue(is_a($obj1, \Helpers\Calendar\Date::class));
        $this->assertEquals("2020-05-31", (string) $obj1);

        $m2 = new Month(2005, 3);
        $d2 = new Dt($m2);
        $obj2 = $d2->getAsObj(2);
        $this->assertTrue(is_a($obj2, \Helpers\Calendar\Date::class));
    ...
    /**
     * @covers Helpers\Calendar\Month\Dt::max
     */
    ...
    /**
     * @covers Helpers\Calendar\Month\Dt::min
     */
    ...
    /**
     * @covers Helpers\Calendar\Month\Dt::has()
     */
