...
{
    /**
     * @covers Helpers\Calendar\Generators\DtListGenerator::__construct
     * @covers Helpers\Calendar\Generators\DtListGenerator::make
     * @covers Helpers\Calendar\Generators\DtListGenerator::include
     * @covers Helpers\Calendar\Generators\DtListGenerator::format
     */
    public function testMake() {
        ...
        $p3 = new \Helpers\Calendar\Period(new Date("2018-10-09"), new Date("2018-10-11"));
