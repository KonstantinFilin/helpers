...
class MonthTest extends TestCase {
     ...
     * @covers Helpers\Calendar\Month::getMonthNum
     * @covers Helpers\Calendar\Month::getMonthNumStr
     */
    ...
    /**
     * @covers Helpers\Calendar\Month::is
     */
    public function testIs()
    {
        $m = new Month();
        $this->assertTrue(is_a($m->is(), \Helpers\Calendar\Month\Is::class));
    }
    
    /**
     * @covers Helpers\Calendar\Month::dt
     */
    public function testDt()
    {
        $m = new Month();
        $this->assertTrue(is_a($m->dt(), \Helpers\Calendar\Month\Dt::class));
    }
